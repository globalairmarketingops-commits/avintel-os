/* =====================================================================
   AvIntelOS — localStorage Store
   Versioned CRUD with staleness detection and corruption recovery.
   Same pattern as AvEngineOS, prefixed with intel_ / avintel_.
   ===================================================================== */
...
const Store = (() => {
  ...
  function isInitialized() {
    return get('intel_initialized') === true;
  }

  function markInitialized() {
    set('intel_initialized', true);
  }

  function resetAll() {
    const keys = Object.keys(localStorage).filter(k =>
      k.startsWith('intel_') || k.startsWith('avintel_') || k.startsWith('windsor_intel_')
    );
